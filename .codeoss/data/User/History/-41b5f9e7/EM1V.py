...
class CarbonMiner:
    ...
    def export_report(self):
        ...
        manifest_path = "/home/wyndhamdesert/market_manifest.json"
        with open(manifest_path, "w") as f:
            json.dump({
                "total_mitigated": round(self.total_mitigated, 2),
    ...
    def get_telegram_updates(self):
        ...
        try:
            requests.get(f"https://api.telegram.org/bot{self.bot_token}/deleteWebhook", timeout=10)
        except: pass
        ...
        while True:
            try:
                ...
                if resp.status_code == 409:
                    print("[!] Telegram Conflict (409): Multiple instances detected. Kill other processes with 'pkill -f carbon_miner.py'.", flush=True)
                    time.sleep(15)
                    continue
