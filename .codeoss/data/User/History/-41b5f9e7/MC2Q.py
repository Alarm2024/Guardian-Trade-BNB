...
class CarbonMiner:
        ...
        for i in range(retries):
            try:
                ...
                if "429" in err_msg or "quota" in err_msg:
                    # Hard quota limit hit. Set cooldown for 60 seconds.
    ...
    def verify_mitigation_ai(self, data):
        if not self.ai_active:
            print("[!] AI Offline. Using fallback logic.", flush=True)
        ...
        # Strict logic fix: If AI is enabled but fails, do NOT auto-mint. Skip instead.
        print("[!] AI Audit enabled but failed to get a clear response. Skipping validation.", flush=True)
        return False
        ...
        while True:
            try:
                ...
                if resp.status_code == 409:
                    print("[!] Telegram Conflict (409): Another instance is running. Waiting 10s...", flush=True)
                    time.sleep(10)
                    continue
